...
%
\title{Art as Technology v0.2.17}
...
\section{Purpose}
    ...
    Apparent differences between art and technology dissolve upon close inspection. Flack has pointed out that coarse graining is frequently wrong \citep[p.8]{FlackCrsGrnng2017}. At best, it is lossy but true. Sometimes it is just lossy. People are hard–wired to look for pattern, and it has apparently been evolutionarily advantageous to see patterns even to the extent that we see them where there are none \citep{FristonThFrEnrgPrncpl2010}. It seems likely that this is has been the case with the pattern of distinction between art and technology.
